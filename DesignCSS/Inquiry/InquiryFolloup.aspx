<%@ Page Title="" Language="C#" MasterPageFile="~/MasterOne.master" AutoEventWireup="true" CodeFile="InquiryFolloup.aspx.cs" Inherits="InquiryFolloup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <form runat="server">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <h5 style="text-align: center; margin-top:50px; margin-bottom: 30px;"><u>Followup Inquiry</u></h5>
            </div>
            <div class="col-lg-3"></div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                ...
                <%--<asp:ImageButton ID="ImageButton1" ImageUrl="~/Images/calendar.png" runat="server" CssClass="btn btn-light" style="position:absolute;top:0px;left:148px;" OnClick="ImageButton1_Click"/>--%>
            </div>
            <div class="col-lg-2">
          ...
          <div class="row" style="position: absolute; top: 437px; left: 200px; width: 140px; height: 30px; z-index:1;">
