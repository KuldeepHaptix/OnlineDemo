<%@ Page Title="" Language="C#" MasterPageFile="~/MasterOne.master" AutoEventWireup="true" CodeFile="TerritoryNew.aspx.cs" Inherits="AllMaster_TerritoryNew" %>
    ...
    <div class="container">
          <form runat="server">
            ...
            <div class="row">
                ...
                <div class="col-sm-3"><h5>Territory</h5></div>
                <div class="col-sm-4"></div>
            </div>
            ...
            <br />
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2" >
                        <asp:Label ID="lblName"  runat="server" Text="Territory Name :"></asp:Label>
                    </div>
                    <div class="col-lg-3">
             ...
             <br />
                <div class="row">
                   ...
                   <div class="col-lg-3"></div>
                    ...
                    <div class="col-lg-2" >
                        <asp:Label ID="lblParent"  runat="server">Parent Territory :</asp:Label>
                    </div>
                    <div class="col-lg-3" >
                  ...
                  <div class="modal-dialog">
                      <div class="modal-content">
                          ...
                          <div class="modal-header">
                              <h4 class="modal-title">Select Parent Territory</h4>
